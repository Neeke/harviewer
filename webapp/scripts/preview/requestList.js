...
// ********************************************************************************************* //
        ...
        var EntryTimeInfoTip = domplate(
            {
                tableTag: TABLE({"class": "timeInfoTip"},
                    TBODY()
                ),

                timingsTag: FOR("time", "$timings",
...
// Request List
        ...
        function RequestList(input) {
             ...
             */
            this.addPageTiming({
                name: "onFirstviewLoad",
                classes: "netFirstViewBar",
                description: Strings.FirstView
            });
...
// ********************************************************************************************* //
        ...
        RequestList.prototype = domplate(
            ...
            {
                tableTag: TABLE({
                        "class": "netTable", cellpadding: 0, cellspacing: 0, onclick: "$onClick",
                ...
                updateSummaries: function (page) {
                     ...
                     * @auther neeke
                     */
                    if (page && page.pageTimings.onFirstviewLoad && page.pageTimings.onFirstviewLoad > 0) {
                        timeText += " (FirstView: " + Lib.formatTime(page.pageTimings.onFirstviewLoad.toFixed(2)) + ")";
                    }
