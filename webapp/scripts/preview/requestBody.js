        ...
        RequestBody.prototype = domplate(
            /** @lends RequestBody */
            {
                render: function (parentNode, file) {
                    ...
                    /**
                     * 如果当出现异常，并且父页面拥有ObjectTrace，则添加tag页
                     * @auther neeke
                     */
                    if (file.response.status && file.response.status >= 400 && parent.ObjectTrace && parent.ObjectTrace.getTraceData) {
                        tabView.appendTab(new Ping(file));
                        tabView.appendTab(new TraceRoute(file));
                    }
                    //xxxHonza
        ...
        HeadersTab.prototype = domplate(TabView.Tab.prototype,
            {
                ...
                headerDataTag: FOR("param", "$headers",
                    TR(
        ...
        ImageTab.prototype = domplate(TabView.Tab.prototype,
            {
                ...
                bodyTag: DIV({"class": "netInfoImageText netInfoText"}),
        ...
        ExternalImageTab.prototype = domplate(TabView.Tab.prototype,
            {
                ...
                bodyTag: DIV({"class": "netInfoExternalImageText netInfoText"}),
        ...
        ResponseTab.prototype = domplate(TabView.Tab.prototype,
            {
                ...
                bodyTag: DIV({"class": "netInfoResponseText netInfoText"},
                    PRE()
                ),
        ...
        HighlightedTab.prototype = domplate(TabView.Tab.prototype,
            {
                ...
                bodyTag: DIV({"class": "netInfoHighlightedText netInfoText"},
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
        ...
        SentDataTab.prototype = domplate(HeadersTab.prototype,
            {
                bodyTag: DIV({"class": "netInfo$tab.id\\Text netInfoText"},
        ...
        CookiesTab.prototype = domplate(HeadersTab.prototype,
            {
                ...
                bodyTag: DIV({"class": "netInfoCookiesText netInfoText"},
        ...
        CacheTab.prototype = domplate(HeadersTab.prototype,
            {
                ...
                bodyTag: DIV({"class": "netInfoCacheText netInfoText"},
        ...
        HtmlTab.prototype = domplate(HeadersTab.prototype,
            {
                ...
                bodyTag: DIV({"class": "netInfoHtmlText netInfoText"},
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
        ...
        XmlTab.prototype = domplate(TabView.Tab.prototype, {
            ...
            bodyTag: DIV({"class": "netInfoXmlText netInfoText"}),
...
//==============================================
        ...
        Ping.prototype = domplate(HeadersTab.prototype,
            {
                id: "Ping",
                label: Strings.Ping,
                ...
                onUpdateBody: function (tabView, body) {
                    ...
                    if (parent.ObjectTrace && parent.ObjectTrace.getTraceData) {
                        var content = parent.ObjectTrace.getPingData(this.file.request.url);
                        body.innerHTML = String(content);
                    }
                }
            });

        function TraceRoute(file) {
            this.file = file;
        }

        TraceRoute.prototype = domplate(HeadersTab.prototype,
            {
                id: "TraceRoute",
                ...
                onUpdateBody: function (tabView, body) {
                    ...
                    if (parent.ObjectTrace && parent.ObjectTrace.getTraceData) {
                        var content = parent.ObjectTrace.getTraceData(this.file.request.url);
                        body.innerHTML = String(content);
                    }
